...
def _make_fill_halos_vector(*, indexers, jit_flags, halo, n_dims, chunker, spanner, left_first):
    set_value = indexers[n_dims].set
    common = _make_common(jit_flags, spanner, chunker)
    halos = ((halo - 1, halo, halo), (halo, halo - 1, halo), (halo, halo, halo - 1))
    # pylint:disable=duplicate-code
...
def __make_outer_outer(*, set_value, jit_flags, halo, n_dims, halos, left_first, **_kwargs):
    @numba.njit(**jit_flags)
...
def __make_outer_mid3d(*, set_value, jit_flags, halo, n_dims, halos, left_first, **_kwargs):
    @numba.njit(**jit_flags)
...
def __make_outer_inner(*, set_value, jit_flags, halo, n_dims, halos, left_first, **_kwargs):
    @numba.njit(**jit_flags)
...
def __make_mid3d_outer(*, set_value, jit_flags, halo, n_dims, halos, left_first, **_kwargs):
    @numba.njit(**jit_flags)
...
def __make_mid3d_mid3d(*, set_value, jit_flags, halo, n_dims, halos, left_first, **_kwargs):
    @numba.njit(**jit_flags)
...
def __make_inner_outer(*, set_value, jit_flags, halo, n_dims, halos, left_first, **_kwargs):
    @numba.njit(**jit_flags)
...
def __make_inner_inner(*, set_value, jit_flags, halo, n_dims, halos, left_first, **_kwargs):
    @numba.njit(**jit_flags)
